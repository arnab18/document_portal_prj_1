...
def test_compare_docuemnts():
    ref_path = Path("D:\\llmops_Training\\document_portal_prj_1\\data\\document_compare\\Long_Report_V1.pdf")
    act_path = Path("D:\\llmops_Training\\document_portal_prj_1\\data\\document_compare\\Long_Report_V2.pdf")
