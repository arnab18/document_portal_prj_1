...
#### This below custom logger is to be created when we dont want to print logs to console but we can use it when we to see the logs by calling it specifically
# class CustomLogger:
#     def __init__(self, log_dir="logs"):
#         # Ensure logs directory exists
#         self.logs_dir = os.path.join(os.getcwd(), log_dir)
